...
int main() {
    ...
    // evaluated when application is being compiled. stored in binary and 
    // re-used in binary whenever exuecuted. Take heavy computations and 
    // move them to comiple time.
    ...
    // int age = 5;
    // static_assert( age == 5 ); // Error - static_assert is a compile time check.
