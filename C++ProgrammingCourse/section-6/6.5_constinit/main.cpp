...
const constinit int age1 {val1}; // const and constinit can be compiled
...
//constexpr constinit double scale_factor {3.11}; // Can't combine constexpr and 


int main() {

    // constinit double height {1.72}; // Cannot use constinit in main
